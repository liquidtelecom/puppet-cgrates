class cgrates::stor_db (
	$stor_db_type				= $cgrates::params::stor_db_type,
	$stor_db_host				= $cgrates::params::stor_db_host,
	$stor_db_port				= $cgrates::params::stor_db_port,
	$stor_db_name				= $cgrates::params::stor_db_name,
	$stor_db_user				= $cgrates::params::stor_db_user,
	$stor_db_password			= $cgrates::params::stor_db_password,
